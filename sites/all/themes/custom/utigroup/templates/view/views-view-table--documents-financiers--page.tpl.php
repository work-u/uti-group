 ...
 */
?>
<div class="h1 titre"><span>Documents financiers</span></div>
<div class="block-7 clearfix">
    <div class="left-wrapper left">
        <div class="clearfix">
            ...
            <ul class="left menu-annee">
                ...
                <li><a class="annee-doc" href="#">2000</a></li>
            </ul>
        </div>
    </div>
    <div class="right-wrapper right">
        <table>
            <thead>
                <tr>
                    <th class="w80">Titre</th>
                    <th class="w20">Documents</th>
                </tr>
            </thead>
            <tbody>
             <?php foreach ($rows as $row): ?>   
                <tr class="tr-annee <?php echo strip_tags($row['field_annees_document']);?>">
                    <td class="w80"><?php echo strip_tags($row['title']);?></td>
                    <td class="w20"><a target="_blank" class="picto-pdf" href="<?php echo $row['field_pdf_document'];?>">PDF</a></td>
                </tr>
           <?php endforeach; ?> 
            </tbody>
        </table>
