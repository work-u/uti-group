...
<!--main -->
<div class="main page page-candidature">
    <div class="main-wrapper">
        <div class="main-content">
            ...
            <div class="h2 sub-title"><?php echo t('Déposez votre CV'); ?></div>
            <div class="clearfix block-5 page-candidature-content">
                <div class="relative">
                    <div class="infos"><?php echo t('Les champs marqués d\'un <sup class="star">*</sup> <br>sont obligatoires') ?></div>
